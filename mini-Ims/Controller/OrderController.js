...
$('.update-order').on('click', function () {
    ...
    orderdetails_db[index].iname = $('#itemname').val().trim();
    ...
    orderdetails_db[index].discount = $('#discount').val().trim();
